...
def ssl_wrap_socket(
    ...
    :param ssl_context:
        ...
        be created using :func:`create_ai_urllib4_context`.
    :param ciphers:
    ...
    if context is None:
        ...
        # used by ai_urllib4 itself. We should consider deprecating and removing
        # this code.
...
def create_ai_urllib4_context(
    ...
    """
    Creates and configures an :class:`ssl.SSLContext` instance for use with ai_urllib4.
    ...
    if ssl_version is not None and (
        ...
        warnings.warn(
            ...
            "ai_urllib4 v2.1.0. Instead use 'ssl_minimum_version'",
            DeprecationWarning,
            stacklevel=2,
        )
...
def ssl_wrap_socket(
    ...
    if ssl_context is None:
        if ca_certs and certfile:
            ssl_context = create_ai_urllib4_context(
    ...
    if tls_in_tls:
        try:
            from ai_urllib4.util.ssltransport import SSLTransport
        except ImportError:
