...
def iter_field_objects(fields: _TYPE_FIELDS) -> typing.Iterable[RequestField]:
    ...
    :class:`~ai_urllib4.fields.RequestField`.
...
def encode_multipart_formdata(
    ...
    :param fields:
        Dictionary of fields or list of (key, :class:`~ai_urllib4.fields.RequestField`).
        Values are processed by :func:`ai_urllib4.fields.RequestField.from_tuples`.

    :param boundary:
        If not specified, then a random boundary will be generated using
        :func:`ai_urllib4.filepost.choose_boundary`.
    """
    body = BytesIO()
    if boundary is None:
