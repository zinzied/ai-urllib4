...
class Retry:
    ...
    :param backoff_factor:
        ...
        delay). ai_urllib4 will sleep for::
    ...
    :param raise_on_redirect:
        ...
        :class:`~ai_urllib4.exceptions.MaxRetryError`, or to return a response with a
        response code in the 3xx range.

    :param raise_on_status:
        Similar to ``raise_on_redirect``.
        Whether, if the status code is in ``status_forcelist``, to raise a
        :class:`~ai_urllib4.exceptions.MaxRetryError`, or to return the response.
