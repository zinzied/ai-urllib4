...
# ai_urllib4 infers URLs without a scheme (None) to be http.
...
class Url(
    ...
    def url(self) -> str:
        ...
        .. code-block:: python
            ...
            U = ai_urllib4.util.parse_url("https://google.com/mail/")

            print(U.url)
            # "https://google.com/mail/"

            print( ai_urllib4.util.Url("https", "username:password",
...
def split_first(
    ...
    delims: typing.Union[str, bytes],
) -> typing.Tuple[typing.Union[str, bytes], typing.Union[str, bytes], typing.Union[str, bytes]]:
    """
    Split a string on the first occurrence of a delimiter.

    Args:
        s: The string to split.
        delims: The delimiters to split on.

    Returns:
        A tuple of (before, delimiter, after).
    """
    min_idx = len(s)
    min_delim = None
    ...
    if min_delim is None:
        return s, type(s)(), type(s)()

    return s[:min_idx], min_delim, s[min_idx + 1:]


def get_host(url: str) -> tuple[str, int | None]:
    """
    ...
    return parsed_url.host or "", parsed_url.port
...
def parse_url(url: str) -> Url:
    ...
    .. code-block:: python
        ...
        print( ai_urllib4.util.parse_url('http://google.com/mail/'))
        # Url(scheme='http', host='google.com', port=None, path='/mail/', ...)

        print( ai_urllib4.util.parse_url('google.com:80'))
        # Url(scheme=None, host='google.com', port=80, path=None, ...)

        print( ai_urllib4.util.parse_url('/foo?bar'))
