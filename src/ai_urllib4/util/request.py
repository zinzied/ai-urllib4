"""
Request utilities for ai_urllib4.
"""
...
def make_headers(
    ...
    .. code-block:: python
        ...
        headers = ai_urllib4.util.make_headers(keep_alive=True, user_agent="ai_urllib4/1.0")
        # {'connection': 'keep-alive', 'user-agent': 'ai_urllib4/1.0'}
    """
