...
def format_header_param_rfc2231(name: str, value: _TYPE_FIELD_VALUE) -> str:
    ...
    """
    warnings.warn(
        "format_header_param_rfc2231 will be removed in ai_urllib4 v2.1.0",
        DeprecationWarning,
        stacklevel=2,
    )
...
def format_header_param_html5(name: str, value: _TYPE_FIELD_VALUE) -> str:
    ...
    """
    warnings.warn(
        "format_header_param_html5 will be removed in ai_urllib4 v2.1.0",
        DeprecationWarning,
        stacklevel=2,
    )
...
class RequestField:
    ...
    def from_tuples(
        ...
        """
        A :class:`~ai_urllib4.fields.RequestField` factory from old-style tuple parameters.

        Supports constructing :class:`~ai_urllib4.fields.RequestField` from
